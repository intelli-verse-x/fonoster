...
import NumberPB, {CreateNumberRequest} from "../../src/service/protos/numbers_pb";
...
describe("@fonoster/service/number", () => {
  ...
  it("correct E164 Number", async () => {
    const numberList = ['16471234567', '+16471234567', '+1(817) 569-8900', '(817) 569-8900']
    ...
    for (let n of numberList) {
      ...
      } as unknown as grpc.ServerUnaryCall<CreateNumberRequest, NumberPB.Number>;
