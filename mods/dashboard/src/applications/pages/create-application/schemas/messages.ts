...
export const VALID_DATE = "The date must be a valid ISO 8601";
export const VALID_DTMF = "Must be a valid DTMF";
export const VALID_LANGUAGE_CODE = "Must be a valid language code";
export const VALID_URL = "Must be a valid URL";
