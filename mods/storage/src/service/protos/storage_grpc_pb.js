...
function deserialize_fonos_storage_v1beta1_GetObjectURLRequest(buffer_arg) {
  return storage_pb.GetObjectURLRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fonos_storage_v1beta1_GetObjectURLResponse(arg) {
  if (!(arg instanceof storage_pb.GetObjectURLResponse)) {
    throw new Error('Expected argument of type fonos.storage.v1beta1.GetObjectURLResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_storage_v1beta1_GetObjectURLResponse(buffer_arg) {
  return storage_pb.GetObjectURLResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fonos_storage_v1beta1_UploadObjectRequest(arg) {
  if (!(arg instanceof storage_pb.UploadObjectRequest)) {
    throw new Error('Expected argument of type fonos.storage.v1beta1.UploadObjectRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_storage_v1beta1_UploadObjectRequest(buffer_arg) {
  return storage_pb.UploadObjectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fonos_storage_v1beta1_UploadObjectResponse(arg) {
  if (!(arg instanceof storage_pb.UploadObjectResponse)) {
    throw new Error('Expected argument of type fonos.storage.v1beta1.UploadObjectResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_storage_v1beta1_UploadObjectResponse(buffer_arg) {
...
var StorageService = exports.StorageService = {
  uploadObject: {
    ...
    requestSerialize: serialize_fonos_storage_v1beta1_UploadObjectRequest,
    requestDeserialize: deserialize_fonos_storage_v1beta1_UploadObjectRequest,
    responseSerialize: serialize_fonos_storage_v1beta1_UploadObjectResponse,
    responseDeserialize: deserialize_fonos_storage_v1beta1_UploadObjectResponse,
  },
  getObjectURL: {
    ...
    requestSerialize: serialize_fonos_storage_v1beta1_GetObjectURLRequest,
    requestDeserialize: deserialize_fonos_storage_v1beta1_GetObjectURLRequest,
    responseSerialize: serialize_fonos_storage_v1beta1_GetObjectURLResponse,
    responseDeserialize: deserialize_fonos_storage_v1beta1_GetObjectURLResponse,
  },
};
