...
* [Storage](#Storage) ⇐ <code>FonosService</code>
    ...
    * [.uploadObjectSync(request)](#Storage+uploadObjectSync) ⇒ <code>Promise.&lt;UploadObjectResponse&gt;</code>
    * [.getObjectURLSync(request)](#Storage+getObjectURLSync) ⇒ <code>Promise.&lt;getObjectURLResponse&gt;</code>
    * [.uploadObject(request)](#Storage+uploadObject) ⇒ <code>Promise.&lt;UploadObjectResponse&gt;</code>
    * [.getObjectURL(request)](#Storage+getObjectURL) ⇒ <code>Promise.&lt;getObjectURLResponse&gt;</code>
    * [.uploadObjectSync(request)](#Storage+uploadObjectSync) ⇒ <code>Promise.&lt;UploadObjectResponse&gt;</code>
    * [.getObjectURLSync(request)](#Storage+getObjectURLSync) ⇒ <code>Promise.&lt;getObjectURLResponse&gt;</code>
...
```
<a name="Storage+uploadObjectSync"></a>

### storage.uploadObjectSync(request) ⇒ <code>Promise.&lt;UploadObjectResponse&gt;</code>
...
```
<a name="Storage+getObjectURLSync"></a>

### storage.getObjectURLSync(request) ⇒ <code>Promise.&lt;getObjectURLResponse&gt;</code>
